...
export const users: User[] = [
  ...
  // { id: "cda32ce5-eb00-46b0-9f53-41aсссf3e62a", name: "Сергей Есенин" }
];
...
export const books: Book[] = [
  ...
  },
  {
    ...
    reviewIds: [
      "3a444249-dd96-48cb-8433-361ea7d48fab",
      "2a447206-211c-4cb7-beab-f7b0bec27ee0",
      "d33c7549-4e34-4c17-82ef-153c1073d9d1"
    ],
    name: "На дороге",
    description:
